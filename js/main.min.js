...
function updatePositions(){frame++;window.performance.mark("mark_start_frame");var items=document.getElementsByClassName("mover");var items_len=items.length;var scroll_top=(document.body.scrollTop/1250)
var phase;for(var i=0;i<items_len;i++){phase=Math.sin(scroll_top+(i%5));items[i].style.transform="translateX("+(100*phase)+"px)"}
